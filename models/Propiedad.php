...
class Propiedad extends ActiveRecord{
    ...
    public function validar(){
        ...
        if(strlen($this->descripcion) < 50){
            self::$errores[] = "Debes agregar una descripcion con al menos 50 caracteres";
        }
    
        if(!$this->habitaciones){
            self::$errores[] = "Debes agregar el numero de habitaciones";
        }
    
        if(!$this->wc){
            self::$errores[] = "Debes agregar el numero de wc's";
        }
